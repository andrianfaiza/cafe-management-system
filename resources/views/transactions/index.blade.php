            ...
            <tbody>
                ...
                <tr>
                            ...
                            <td>
                                ...
                                @else
                                <form action="{{ route('transactions.done', $transaksi->id)}}" method="post">
                                    @csrf
                            ...
                            <td class="action">
                                <a href="{{ route('transactions.show', $transaksi->id) }}" class="btn-tambah">Detail</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left">
                                 <div class="action1">
                                    ...
                                    <a href="{{ route('transactions.create')}}" class="btn-tambah">+ Add Transaction</a>
                                </div>
                            </td>
                        </tr>
            </tbody>
